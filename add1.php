...
<a href="index1.html"><button class="btn btn-success" style="border-radius:30px;"><i class="fa fa-phone" style="font-size: 40px;"></i></button><span style="font-size: 24px;color:black;">          Join the video call</span></a>
