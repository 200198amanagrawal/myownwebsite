...
<div class="Container-fluid">
  ...
  <div class="row">
              <ul class="thumbnails xxx">
                <li class="col-sm-3">
                  <div class="thumbnail">
                    <a  href="product_det.php"><img src="images/p1.jpg" alt=""></a>
                    <div class="caption">
                      ...
                      <h4 style="text-align:center"><a class="btn btn-primary" href="#"><?php echo $_SESSION["amt"]*7;
                        ?></a><button type="submit" class="btn btn-primary" style="margin-left: 8px;color:white;">Add to cart</button></h4></form>
                    </div>
                  </div>
                </li>
              </ul>
