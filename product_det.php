...
<div class="container-fluid" id="top">
  ...
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="website.html">MyownWebsite</a>
    </div>
...
<div class="col-sm-4">
    <div class="page">
        ...
        <div class="sp-wrap">
            <a href="images/2a.jpg"><img src="images/2_tb.jpg" alt=""></a>
            <a href="images/3a.jpg"><img src="images/3_tb.jpg" alt=""></a>
            <a href="images/5a.jpg"><img src="images/5_tb.jpg" alt=""></a>
...
<form>
  ...
  <form>
    <a href="index.php" style="margin-right:20px;padding:10px; margin-bottom:20px;"></a>
  </form>
  <form>
  <input type="submit" class="myButton" style="margin-right:20px;padding:10px; margin-bottom:20px;" name="buynow" value="Rent">
</form>
<br>
</div>
