  ...
  <div class="modal-dialog">
    ...
    <button type="submit" class="btn" style="width:100%;background-color:#70449f;color:white;">Login</button>
      ...
      <div class="modal-footer">
        ...
        <p>Not a member? <a href="#" q>Sign Up</a></p>
...
<div id="myModal1" class="modal fade" role="dialog">
  <div class="modal-dialog">
	<div class="modal-content">
      ...
      <br>
      <div class="modal-body">
        <form action="xx.php" method="POST"  onsubmit="return validate()">
        	<div class="input-group">
   ...
   <!--
      ...
      function validate()
      {
         ...
         if( document.getElementById('name').value == "" )
         {
          ...
          alert( "Please provide a proper format for the name!" );
            return false;
         }
         ...
         if( document.getElementById('password1').value == "")
         {
          ...
          var patt1 = /[A-Z0-9]*/g;
          var result = str.match(patt1);
          alert( "Please provide a proper format for the password!" );
            return false;
         }
         return( true );
      }
